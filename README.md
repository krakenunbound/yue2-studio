...
- Windows generation uses cuDNN attention and CUDA graphs. On a 3090, a 4:22 song generated in 3:09 (was ~15 minutes).
- Radio plays the library as a station. Optional LAN sharing on port 6969 (no password); the desktop sidecar stays on 7794.
